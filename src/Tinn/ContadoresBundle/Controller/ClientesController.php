...
use Tinn\ContadoresBundle\Entity\Clientes;
use Tinn\ContadoresBundle\Form\ClientesType;
use Tinn\ContadoresBundle\Form\ClientesFilterType;
...
class ClientesController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new ClientesFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('ContadoresBundle:Clientes')->createQueryBuilder('e');
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($session->has('ClientesControllerFilter')) {
                ...
                $filterForm = $this->createForm(new ClientesFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('clientes', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("ContadoresBundle:Clientes:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ContadoresBundle:Clientes')->find($id);
     ...
     * @Method("PUT")
     * @Template("ContadoresBundle:Clientes:edit.html.twig")
     */
